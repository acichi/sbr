...
<head>
  ...
  <style>
    ...
    .btn-primary:hover {
      background-color: #689c8c !important;
      border-color: #689c8c !important;
    }
    
    .btn-secondary {
      background-color: #e19985 !important;
      border-color: #e19985 !important;
    }
    
    .btn-secondary:hover {
      background-color: #d38674 !important;
      border-color: #d38674 !important;
    }
    ...
    .btn-success:hover {
      background-color: #cf7d4d !important;
      border-color: #cf7d4d !important;
    }
...
<body class="bg-light">
<?php include('../menu/menu_client.php'); ?>
    ...
    <div class="col-lg-4">
      <?php if (!empty($userData)): ?>
        <div class="card h-100 shadow-lg rounded-3">
          <div class="card-header text-white text-center" style="background-color: #7ab4a1; padding: 15px;">
            <h5>Good Day!</h5>
        ...
        <div class="col-md-4">
          <div class="card h-100 shadow-lg rounded-3 border-0">
            ...
            <div class="card-body d-flex flex-column">
              ...
              <p class="fw-bold" style="color: #e08f5f;">Price: ₱<?= number_format($row['price'], 2) ?></p>
              <button
    ...
    <div class="modal-content rounded-4 shadow">
      ...
      <div class="modal-body">
        <?php if (!isset($_SESSION['fullname'])): ?>
          <div class="alert alert-warning text-center" style="background-color: rgba(224, 143, 95, 0.1); color: #e08f5f; border-color: #e08f5f;">
            <strong>Note:</strong> You must <a href="../login.php" style="color: #e08f5f; text-decoration: underline;">log in</a> to make a reservation.
          </div>
        <?php endif; ?>
      ...
      cashAmountInput.addEventListener("input", function() {
        ...
        if (!isNaN(cashAmount) && !isNaN(totalPrice)) {
          if (cashAmount >= totalPrice) {
            ...
            paymentResultDiv.style.color = "#7ab4a1";
          } else {
            paymentResultDiv.textContent = `Insufficient amount!`;
            paymentResultDiv.style.color = "#e19985";
          }
        }
      });
